...
const IndexHtml* = staticHtmlDocument:
  buildHtml(html):
    ...
    body:
      tdiv(id="mining")
      script(src="/mining.js")
      verbatim gitHubCorners("https://github.com/zenywallet/zenyminer")

const srcPath = currentSourcePath().parentDir()

macro genarateHtml() =
  writeFile(srcPath / "mining.html", IndexHtml)
